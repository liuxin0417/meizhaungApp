...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__goods_list__ = __webpack_require__(820);
...
GoodsListPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__goods_list__["a" /* GoodsListPage */]),
...
var GoodsListPage = (function () {
    function GoodsListPage(navCtrl, navParams, httpService, nativeService, Inservice) {
    ...
    GoodsListPage.prototype.ionViewDidLoad = function () {
    };
    GoodsListPage.prototype.updategoods = function (num) {
    ...
    GoodsListPage.prototype.changenum = function (index, item) {
        this.num = index;
        item.show = !item.show;
    ...
    GoodsListPage.prototype.changenum2 = function (index, item) {
        this.num2 = index;
        item.show = !item.show;
    ...
    //重置
    GoodsListPage.prototype.reset = function () {
        this.BrandID = [];
        this.Category = [];
        this.SmallPrice = 0;
        this.BigPrice = 0;
    ...
    GoodsListPage.prototype.resigiter = function () {
        var _this = this;
        var userInfo = {
        ...
        this.httpService.post("/MobService/Index", parameter).map(function (res) { return res.json(); }).subscribe(function (res) {
            ...
            if (result.Code == 1) {
                ...
                _this.CategoryLiat = result.Data.lstCategory;
    ...
    GoodsListPage.prototype.getlist = function (num) {
        var _this = this;
        var num = num;
        var userInfo = {
    ...
    GoodsListPage.prototype.gotoGoodDetail = function (id) {
        this.navCtrl.push("GoodDetailPage", {
            Fh: this.address,
            goodsid: id,
        });
    };
    GoodsListPage.prototype.slice = function (string) {
        if (string != "" && string != null) {
            return string.slice(0, 25) + "...";
        }
    };
    GoodsListPage.prototype.goshow = function () {
        this.type = 3;
        this.coverpart = true;
        this.slidepart = true;
    };
    GoodsListPage.prototype.gohide = function () {
        var that = this;
        this.slidepart = false;
        setTimeout(function () {
    ...
    GoodsListPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
    ...
    GoodsListPage.prototype.change = function () {
        if (this.showType == 1) {
            this.showType = 2;
        }
        else {
    ...
    GoodsListPage.prototype.toTop = function () {
        this.content.scrollTo(0, 0, 300);
    };
    GoodsListPage.prototype.gotosearch = function () {
        // //console.info("11")
        this.navCtrl.push("SearchPage");
    };
    GoodsListPage.prototype.gotoLeavel2 = function () {
        this.showlevel = 2;
    };
    GoodsListPage.prototype.gotoLeavel1 = function () {
        this.showlevel = 1;
    };
    GoodsListPage.prototype.gotoLeavel3 = function () {
        this.showlevel = 3;
    };
    GoodsListPage.prototype.chosetype1 = function (item2) {
    ...
    GoodsListPage.prototype.settle = function () {
        var that = this;
        wx.onMenuShareAppMessage({
            ...
            link: 'https://www.lguangguang.com/mob/?from=groupmessage#/goods-list/' + this.Bh + '/' + this.name,
...
//# sourceMappingURL=165.js.map?v=107