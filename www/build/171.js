...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExchangeGoodsPageModule", function() { return ExchangeGoodsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__exchange_goods__ = __webpack_require__(765);
...
var ExchangeGoodsPageModule = (function () {
    function ExchangeGoodsPageModule() {
    }
    return ExchangeGoodsPageModule;
}());
ExchangeGoodsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__exchange_goods__["a" /* ExchangeGoodsPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__exchange_goods__["a" /* ExchangeGoodsPage */]),
        ],
    })
], ExchangeGoodsPageModule);

//# sourceMappingURL=exchange-goods.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExchangeGoodsPage; });
 ...
 */
var ExchangeGoodsPage = (function () {
    function ExchangeGoodsPage(navParams, navCtrl, httpService, nativeService, Inservice, modalCtrl) {
        ...
        this.img2 = "assets/imgs/jiaohuan.png";
    ...
    ExchangeGoodsPage.prototype.ionViewDidLoad = function () {
        this.login();
        this.login2();
        this.login4();
    };
    ExchangeGoodsPage.prototype.gotoindex = function (i) {
        this.indexnum = i;
    };
    ExchangeGoodsPage.prototype.login = function () {
        var _this = this;
        var userInfo = "";
    ...
    ExchangeGoodsPage.prototype.login2 = function () {
        var _this = this;
        var userInfo = "";
        var parameter = new __WEBPACK_IMPORTED_MODULE_3__model_Model__["f" /* Parameter */]();
        parameter.jyh = "1078";
    ...
    /**获取社区导航 */
    ExchangeGoodsPage.prototype.login4 = function () {
        var _this = this;
        var userInfo = "";
        var parameter = new __WEBPACK_IMPORTED_MODULE_3__model_Model__["f" /* Parameter */]();
        parameter.jyh = "1095";
    ...
    /**获取社区的文章 */
    ExchangeGoodsPage.prototype.login3 = function (num, NavID) {
        var _this = this;
        this.indexnum = num;
        this.NavID = NavID;
        var userInfo = {
    ...
    ExchangeGoodsPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
    ...
    ExchangeGoodsPage.prototype.gotoslide = function (item) {
        var imgarry = [];
        // var img = { "Url": item };
    ...
    ExchangeGoodsPage.prototype.gotohotplate = function () {
        this.navCtrl.push("HotPlatePage", {
            themeList: this.themeList,
            type: 3,
        });
    };
    ExchangeGoodsPage.prototype.gotoperson = function (item) {
        //console.log(item);
    ...
    ExchangeGoodsPage.prototype.gotoarticle = function () {
        var modal = this.modalCtrl.create('PublishArticlesPage', {
            type: 3
        });
        modal.present();
    };
    ExchangeGoodsPage.prototype.gotoinfo = function (item) {
        this.navCtrl.push('PersonalArticlePage', {
            ID: item.ArticleID,
            type: 3
        });
    };
    ExchangeGoodsPage.prototype.goback = function () {
        this.navCtrl.pop();
    };
    ExchangeGoodsPage.prototype.MyCommunityPage = function () {
...
//# sourceMappingURL=exchange-goods.js.map

/***/ })

});
//# sourceMappingURL=171.js.map?v=107