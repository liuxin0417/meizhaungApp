...
@IonicPage()
@Component({
  selector: 'page-public-welfare',
  templateUrl: 'public-welfare.html',
})
export class PublicWelfarePage {
  img1 = "assets/imgs/fanhui2.png";
  img2 = "assets/imgs/gongyi.png";
  ...
  inform = {
    ID: "e4e722b3-f0b1-4b44-965f-ac3b822c83b0", ImgUrl: "http://192.168.8.99:8063/doc/ZDNF\thumbs/e4e722b3-f0b1-4b44-965f-ac3b822c83b0_80_square.png", Info:
      "类别描述", Name: "食来孕转", Num: 3, PeopleSum: 2, RelImgUrl: "http://192.168.8.99:8063/doc/ZDNF/Coupon/20171228/20171228152338145.png", typebh: "02"}
  private NavID = "";
  private isshow = true;
