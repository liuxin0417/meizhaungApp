...
@IonicPage({
  segment: 'floorlist/:fid/:name',
  defaultHistory: ['TabsPage']

})
@Component({
  selector: 'floor-goodlist',
  templateUrl: 'floor-goodlist.html',
})
export class FloorGoodlistPage {
  list = [];
  ...
  settle() {
    ...
    wx.onMenuShareAppMessage({
      ...
      link: 'https://www.lguangguang.com/mob/?from=groupmessage#/floorlist/' + this.Bh + '/' + this.name, // 分享链接
